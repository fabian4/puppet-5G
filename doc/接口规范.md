...
## <a name="18">六、Chatbot 发送消息（消息单发）</a>
...
### <a name="23">5. 富媒体卡片消息(带 CSS 样式) + Suggestions </a>
...
### <a name="24">6. 富媒体多卡片消息(带 CSS 样式) + Suggestions</a>
...
## <a name="36">九、Chatbot 接收下行消息的状态报告 </a>
...
## <a name="41">十一、富媒体卡片支持的 CSS 属性说明</a>
